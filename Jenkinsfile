        ...
        stage('Docker Image') {
            ...
            steps {
                script {
                    ...
                    sh 'docker run -d --rm --name cardshifter_server -v $(pwd):/usr/src/cardshifter -p 192.168.0.110:22737:4242 -p 192.168.0.110:22738:4243 -v /home/zomis/jenkins/cardshifter:/data/logs -w /data/logs openjdk:8-jre'
                }
            }
        }
