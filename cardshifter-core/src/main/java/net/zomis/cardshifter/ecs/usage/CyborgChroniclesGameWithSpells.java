...
public class CyborgChroniclesGameWithSpells extends CyborgChroniclesGameNewAttackSystem {
...
//				targetSupplier.get());
		...
		createTargetSpell("", zone, 4, 2, effects.giveTarget(e -> new UntilEndOfOwnerTurnSystem(e, new EntityCannotUseSystem(e, CyborgChroniclesGame.ATTACK_ACTION))),
		...
		ResourceRetriever health = ResourceRetriever.forResource(CyborgChroniclesResources.HEALTH);
...
//				targetSupplier.get());
		createTargetSpell("Decrease Health", zone, 2, 2, effects.giveTarget(CyborgChroniclesResources.HEALTH, -2, healthLimit), targetSupplier.get());
		createTargetSpell("Decrease Attack", zone, 2, 2, effects.giveTarget(CyborgChroniclesResources.ATTACK, -2, attackLimit), targetSupplier.get());
