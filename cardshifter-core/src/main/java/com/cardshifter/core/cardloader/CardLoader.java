...
public interface CardLoader<I> {
	 ...
	 * @param resources	The resources to be transformed to
	 ...
	 */
	Collection<Entity> loadCards(I input, Supplier<Entity> entitySupplier, ECSResource[] resources) throws CardLoadingException;
}
